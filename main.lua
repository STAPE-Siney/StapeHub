...
local function StartCheat(expiration)
    ...
    RunService.RenderStepped:Connect(function()
        ...
        if char and char:FindFirstChild("Humanoid") then
            ...
            if _G.NeoStrafe and hum.FloorMaterial == Enum.Material.Air then hrp.Velocity = Vector3.new(hum.MoveDirection.X * 80, hrp.Velocity.Y, hum.MoveDirection.Z * 80) end
        end
